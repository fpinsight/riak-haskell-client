...
$SED -e 's/Rpb//g' -e 's/Req/Request/g' -e 's/Resp/Response/g' \
    ...
    src/riak.proto src/riak_kv.proto src/riak_ts.proto src/riak_dt.proto src/riak_yokozuna.proto src/riak_search.proto src/riakextra.proto > src/Protocol.proto
